...
function EditListing() {
  ...
  const { type, name, bedrooms, bathrooms, parking, address, offer, regularPrice, discountedPrice, images, latitude, longitude, furnished } = formData
  const auth = getAuth()
  ...
  useEffect(() => {
    //   useRef is userId in this project
